...
const Forgot = () => {
  ...
  return (
    <div><div className=" mt-2 min-h-full flex items-center justify-center px-4 sm:px-6 lg:px-8">
    <div className="max-w-md w-full space-y-8">
      <div>
       <Link href='/'><img className="mx-auto h-12 w-auto" src="wear.png" alt="Workflow"/></Link>
        <h2 className="mt-2 text-center text-3xl tracking-tight font-bold text-gray-900">Forgot Password</h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          Or
          <Link href='/'><a href="#" className="font-medium text-pink-600 hover:text-pink-500"> Signin </a></Link>
        </p>
      </div>
